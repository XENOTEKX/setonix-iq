...
import { store } from '../state.js?v=20260430114511';
import { loadRun } from '../data.js?v=20260430114511';
import { mountRunPicker } from '../components/run-picker.js?v=20260430114511';
import { bindCopyButtons } from '../components/copy-button.js?v=20260430114511';
import { attachExpand } from '../components/chart-expand.js?v=20260430114511';
import * as scaling from '../charts/scaling.js?v=20260430114511';
import * as efficiency from '../charts/efficiency.js?v=20260430114511';
import * as ipcScaling from '../charts/ipc-scaling.js?v=20260430114511';
import * as perfMatrix from '../charts/performance-matrix.js?v=20260430114511';
import { escHtml, fmtTime, fmtNum } from '../utils.js?v=20260430114511';
