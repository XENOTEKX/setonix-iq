#!/bin/bash
# run_fca_mfp_dna1m_np1.sh — FCA -m MFP scaling: np=1, DNA 1M.
#
# PURPOSE: Measure FCA ModelFinder performance with -m MFP at np=1 for DNA 1M.
...
LABEL="fca_mfp_dna1m_np1_seed${SEED}"
...
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  FCA -m MFP scaling: DNA 1M np=1  seed=${SEED}"
...
echo ""
echo "══ FCA -m MFP DNA 1M np=1 result ══════════════════════"
echo "  exit code:  ${RC}"
echo "  lnL:        ${LNL}"
