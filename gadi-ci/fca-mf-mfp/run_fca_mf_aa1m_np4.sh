#!/bin/bash
# run_fca_mf_aa1m_np4.sh — FCA -m MF scaling: np=4, AA 1M.
#
# PURPOSE: Measure FCA ModelFinder performance with -m MF at np=4 for AA 1M.
...
LABEL="fca_mf_aa1m_np4_seed${SEED}"
...
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  FCA -m MF scaling: AA 1M np=4  seed=${SEED}"
...
echo ""
echo "══ FCA -m MF AA 1M np=4 result ══════════════════════"
echo "  exit code:  ${RC}"
echo "  lnL:        ${LNL}"
