#!/bin/bash
# run_fca_mfp_aa1m_np1.sh — FCA -m MFP scaling: np=1, AA 1M.
#
# PURPOSE: Measure FCA ModelFinder performance with -m MFP at np=1 for AA 1M.
...
LABEL="fca_mfp_aa1m_np1_seed${SEED}"
...
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  FCA -m MFP scaling: AA 1M np=1  seed=${SEED}"
...
echo ""
echo "══ FCA -m MFP AA 1M np=1 result ══════════════════════"
echo "  exit code:  ${RC}"
echo "  lnL:        ${LNL}"
