#!/bin/bash
# run_fca_mfp_dna1m_np4.sh — FCA -m MFP scaling: np=4, DNA 1M.
#
# PURPOSE: Measure FCA ModelFinder performance with -m MFP at np=4 for DNA 1M.
...
LABEL="fca_mfp_dna1m_np4_seed${SEED}"
...
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  FCA -m MFP scaling: DNA 1M np=4  seed=${SEED}"
...
echo ""
echo "══ FCA -m MFP DNA 1M np=4 result ══════════════════════"
echo "  exit code:  ${RC}"
echo "  lnL:        ${LNL}"
