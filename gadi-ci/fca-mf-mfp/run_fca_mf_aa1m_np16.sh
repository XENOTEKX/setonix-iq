#!/bin/bash
# run_fca_mf_aa1m_np16.sh — FCA -m MF scaling: np=16, AA 1M.
#
# PURPOSE: Measure FCA ModelFinder performance with -m MF at np=16 for AA 1M.
...
LABEL="fca_mf_aa1m_np16_seed${SEED}"
...
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  FCA -m MF scaling: AA 1M np=16  seed=${SEED}"
...
echo ""
echo "══ FCA -m MF AA 1M np=16 result ══════════════════════"
echo "  exit code:  ${RC}"
echo "  lnL:        ${LNL}"
