#!/bin/bash
# run_fca_mf_aa1m_np2.sh — FCA -m MF scaling: np=2, AA 1M.
#
# PURPOSE: Measure FCA ModelFinder performance with -m MF at np=2 for AA 1M.
...
LABEL="fca_mf_aa1m_np2_seed${SEED}"
...
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  FCA -m MF scaling: AA 1M np=2  seed=${SEED}"
...
echo ""
echo "══ FCA -m MF AA 1M np=2 result ══════════════════════"
echo "  exit code:  ${RC}"
echo "  lnL:        ${LNL}"
