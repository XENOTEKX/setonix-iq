#!/bin/bash
# run_fca_mfp_dna1m_np2.sh — FCA -m MFP scaling: np=2, DNA 1M.
#
# PURPOSE: Measure FCA ModelFinder performance with -m MFP at np=2 for DNA 1M.
...
LABEL="fca_mfp_dna1m_np2_seed${SEED}"
...
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  FCA -m MFP scaling: DNA 1M np=2  seed=${SEED}"
...
echo ""
echo "══ FCA -m MFP DNA 1M np=2 result ══════════════════════"
echo "  exit code:  ${RC}"
echo "  lnL:        ${LNL}"
