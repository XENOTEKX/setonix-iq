#!/bin/bash
# run_fca_mf_dna1m_np16.sh — FCA -m MF scaling: np=16, DNA 1M.
#
# PURPOSE: Measure FCA ModelFinder performance with -m MF at np=16 for DNA 1M.
...
LABEL="fca_mf_dna1m_np16_seed${SEED}"
...
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  FCA -m MF scaling: DNA 1M np=16  seed=${SEED}"
...
echo ""
echo "══ FCA -m MF DNA 1M np=16 result ══════════════════════"
echo "  exit code:  ${RC}"
echo "  lnL:        ${LNL}"
