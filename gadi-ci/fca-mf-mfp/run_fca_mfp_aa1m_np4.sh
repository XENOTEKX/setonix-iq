#!/bin/bash
# run_fca_mfp_aa1m_np4.sh — FCA -m MFP scaling: np=4, AA 1M.
#
# PURPOSE: Measure FCA ModelFinder performance with -m MFP at np=4 for AA 1M.
...
LABEL="fca_mfp_aa1m_np4_seed${SEED}"
...
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  FCA -m MFP scaling: AA 1M np=4  seed=${SEED}"
...
echo ""
echo "══ FCA -m MFP AA 1M np=4 result ══════════════════════"
echo "  exit code:  ${RC}"
echo "  lnL:        ${LNL}"
