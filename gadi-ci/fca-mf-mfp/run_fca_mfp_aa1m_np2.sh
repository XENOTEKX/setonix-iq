#!/bin/bash
# run_fca_mfp_aa1m_np2.sh — FCA -m MFP scaling: np=2, AA 1M.
#
# PURPOSE: Measure FCA ModelFinder performance with -m MFP at np=2 for AA 1M.
...
LABEL="fca_mfp_aa1m_np2_seed${SEED}"
...
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  FCA -m MFP scaling: AA 1M np=2  seed=${SEED}"
...
echo ""
echo "══ FCA -m MFP AA 1M np=2 result ══════════════════════"
echo "  exit code:  ${RC}"
echo "  lnL:        ${LNL}"
