...
#
# Binary:  /scratch/rc29/as1708/iqtree3-mf-iso/build-mpi-iso/iqtree3-mpi
...
if ! nm -C "${IQTREE}" 2>/dev/null | grep -q 'CandidateModelSet::filterRatesMPI(int)'; then
    echo "ERROR: ${IQTREE} missing filterRatesMPI symbol (wrong build?)" >&2; exit 7
fi
