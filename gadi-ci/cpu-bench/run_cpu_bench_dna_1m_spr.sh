#!/bin/bash
# run_cpu_bench_dna_1m_spr.sh — IQ-TREE3 cpu_opt_merge CPU benchmark
# DNA, 1M sites (100 taxa), Sapphire Rapids node, -nt 103, seed=1
...
echo "╔══════════════════════════════════════════════════════════╗"
echo "║  CPU Benchmark — DNA 1M · normalsr · -nt ${THREADS}"
