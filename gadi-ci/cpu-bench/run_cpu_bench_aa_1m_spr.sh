#!/bin/bash
# run_cpu_bench_aa_1m_spr.sh — IQ-TREE3 cpu_opt_merge CPU benchmark
# AA, 1M sites (100 taxa), Sapphire Rapids node, -nt 103, seed=1
...
#
# BLOCKED: AA 1M tree_1 directory has drw-rwSrw- (no execute bit).
# Ask sa0557: chmod o+x .../AA/LG+I+G4/taxa_100/len_1000000/tree_1
#
#PBS -N iq-cpu-aa-1m-spr
#PBS -P dx61
#PBS -q normalsr
#PBS -l ncpus=104
#PBS -l mem=510GB
...
RUN_LABEL="${DATA_TYPE}_1m_spr_seed${SEED}"
...
echo "╔══════════════════════════════════════════════════════════╗"
echo "║  CPU Benchmark — AA 1M · normalsr · -nt ${THREADS}"
