#!/bin/bash
# run_cpu_bench_dna_100k_spr.sh — IQ-TREE3 cpu_opt_merge CPU benchmark
# DNA, 100K sites (100 taxa), Sapphire Rapids node, -nt 103, seed=1
...
echo "╔══════════════════════════════════════════════════════════╗"
echo "║  CPU Benchmark — DNA 100K · normalsr · -nt ${THREADS}"
