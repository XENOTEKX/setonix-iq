...
# Output:  /scratch/rc29/as1708/iqtree3-mf-iso/build-atmd-b3b/iqtree3-mpi
...
BUILD_DIR="${BUILD_DIR:-${ISO_DIR}/build-atmd-b3b}"
BINARY_NAME="iqtree3-mpi-atmd-b3"
...
{
  "build_tag":     "atmd_b3b_icx_avx512_spr",
