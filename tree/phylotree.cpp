...
//    }
    ...
    if (params && params->gpu && !params->jolt) { gpuLnLCrossCheckOnce(score); gpuMixLnLCrossCheckOnce(score); gpuDervCrossCheckOnce(); gpuMixDervCrossCheckOnce(); gpuMixWeightEMCrossCheckOnce(); gpuFreeQGradCheckOnce(); }
#endif
    return score;
}
